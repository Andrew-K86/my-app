import bgImgDesk from '../../assets/images/bg-sidebar-desktop.svg'
import bgImgMob from '../../assets/images/bg-sidebar-mobile.svg'
...
const NavSideBar = ({ page }) => {
    ...
    return (
        <div className="navSideBar" style={{ backgroundImage: isBigScreen ? `url(${bgImgDesk})` : `url(${bgImgMob})` }}>
            <div className="page">
